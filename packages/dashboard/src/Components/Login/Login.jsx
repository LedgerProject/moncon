...
const Login = () => {
  ...
  const { setUserRole, setIsLoading, isUserAuthed, logout } =
    useContext(AppContext);
  const [userType, setUserType] = useState(
    localStorage.getItem(LS_KEY_ROLE) || ROLE_PUBLISHER
  );
    ...
    <ThemeProvider theme={publisherTheme}>
      ...
      <Grid container justify="center">
        <Grid container justify="center" item xs={12}>
          <img
            src={userType === ROLE_PUBLISHER ? moncon_negro : moncon_blanco}
            alt="logo"
