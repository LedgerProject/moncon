...
import { LS_KEY_ROLE, LS_KEY_TOKEN, ROLES_DEFAULT_ROUTES, ROLE_PUBLISHER} from '../../Constants';
                            ...
                            <Grid container justify='center'>
                                ...
                                { !isLogin && (
                                    <Grid container justify='center'>
                                        <TextField 
                                            ...
                                            className={classes.textField}  
                                            helperText={
                                                password !== passwordRepeat?"The passwords are diferent":''
                                            } 
                                        />
                                    </Grid>
                                )}
                                ...
                                <Grid container justify='center'>
                                    ...
                                    onClick={handleChangeLoginRegister}>
                                        {isLogin ? 'Register as publisher' : 'Login to your account'}
                                    </Typography>
                                </Grid>
                            </Grid>
                        </Paper>
                        <Grid container justify='center' className={classes.publisherProviderButtons}>
