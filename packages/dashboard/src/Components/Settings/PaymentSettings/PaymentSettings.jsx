import { Typography , TextField, Button, Paper, makeStyles, Grid, Link } from "@material-ui/core";
...
const PaymentSettings = ()=>{
    ...
    const stripeAccount = async () => {
        ...
        console.log(account)
        const response = await apiService.post('/publisher/account-link',{stripeAccountId: stripeAccountId || account});
        ...
        setLinkExpireAt(`your link expires at ${moment(expires_at).format('DDD/MM HH:mm')}`);
            ...
            <Paper className={classes.root} elevation={0} >
                <Grid className={classes.description}>
                    ...
                    <Typography variant='subtitle2'>
                        Create and account on Stripe to recive your payments just clicking here
                    </Typography>
                </Grid>
                <Grid>
                    <Button variant="contained" color="primary" component="span" onClick={stripeAccount} >
                        {
