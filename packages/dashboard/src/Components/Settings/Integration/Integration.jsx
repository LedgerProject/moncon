...
const Integration = ()=> {
    ...
    return(
            <Paper className={classes.root} >
                ...
                <Typography variant='body2' className={classes.description}>Just copy the Moncon script and 
                past it inside your website</Typography>
                <Paper variant='outlined' className={classes.scripts} >
                    <pre>
                        &lt;link rel="stylesheet" href="{process.env.REACT_APP_MONCON_CDN_URL}/moncon.css"&gt;
                    </pre>
                    <pre>
                        &lt;script src="{process.env.REACT_APP_MONCON_CDN_URL}/moncon.js?id={userId}" async&gt;&lt;/script&gt;
                    </pre>
