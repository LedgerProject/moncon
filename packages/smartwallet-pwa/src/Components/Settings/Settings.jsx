...
const Settings = () => {
  ...
  const [card,setCard] = useState(window.localStorage.getItem(LS_PAYMENT_METHOD_KEY))
  ...
  const deleteCard = async () => {
    ...
    try{
      const response = await apiService.post('/user/card-delete',{card,customer});
  ...
  return (
      ...
      <div className={classes.root}>
        ...
        <div>
         ...
         <div className={classes.contentSetting}>
          ...
          <div className={classes.contentSetting}>
            <Link to={`mailto:hello@moncon.co`}  style={{ textDecoration: 'none' }}>
            <Fab color="secondary" aria-label="edit" className={classes.fab}>
              <IconMail />
            </Fab>
            </Link>
   ...
   <div className={classes.contentSetting}>
<Link to={`https://moncon.co`} target={"_blank"}  style={{ textDecoration: 'none' }}>
            <Fab color="secondary" aria-label="edit" className={classes.fab}>
              <IconWeb />
            </Fab>
</Link>
          ...
          <div className={classes.contentSetting}>
<Link to={`https://moncon.co/privacy-policy/`} target={"_blank"}  style={{ textDecoration: 'none' }}>
            <Fab color="secondary" aria-label="edit" className={classes.fab}>
              <IconPrivacy />
            </Fab>
</Link>
          ...
          <div className={classes.contentSetting}>
<Link to={`https://moncon.co/terms-of-services/`} target={"_blank"}  style={{ textDecoration: 'none' }}>
            <Fab color="secondary" aria-label="edit" className={classes.fab}>
              <IconSpeaker />
            </Fab>
</Link>
