...
const DemoRegion = () => {
  ...
  const [data, setData] = useState(JSON.parse(localStorage.getItem(credential_region)));
    ...
    <>
      ...
      <div style={{ marginTop: "15px" }}>
        <div className={classes.proofContainerWhite}>
          ...
          <div>
            <div className={classes.issuedSubtitle}>Region of Residence</div>
            <Link
              to="https://moncon.co/"
              target={"_blank"}
      ...
      >
        <div>
          <div style={{ marginLeft: "20px" }}>
            ...
            <p className={classes.documentsMessage}>{region.value}</p>
          </div>
        </div>
      </div>
